...
const ShiftStartApprovalScene = () => {
    const [employeeId, setEmployeeId] = useState<string>();
    const [shiftId, setShiftId] = useState<string>();
    const [fullName, setFullName] = useState<string>();
    const { validateEmployeeId, approveRequestCheckin } = useShiftSPV();
    ...
    const handleSubmit = () => {
        LoggingUtils.log('handleSubmit', employeeId);
        if (fullName && shiftId) {
            approveRequestCheckin(shiftId);
        }
    };
...
export default ShiftStartApprovalScene;
